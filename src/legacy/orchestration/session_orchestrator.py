...
from src.legacy.agents.evaluator_agent import EvaluatorAgent
from src.legacy.agents.extraction_agent import ExtractionAgent
from src.legacy.agents.interviewer_agent import InterviewerAgent
from src.config import Config
from src.legacy.core.graph_manager import GraphManager
from src.legacy.orchestration.planner_decision_policy import (
    PlannerDecisionPolicy,
    PlannerDecisionWeights,
    pick_undercovered_theme,
)
from src.legacy.orchestration.routing_calibration import (
    PersonalizedRoutingConfig,
    RoutingCalibrator,
    seed_config_from_elder_info,
)
from src.orchestration.state_store import InMemorySessionStateStore
from src.legacy.orchestration.turn_routing_policy import (
    GRAPH_FAST_ROUTE,
    GRAPH_UPDATE_ROUTE,
    TurnRoutingPolicy,
)
from src.legacy.services import (
    CoverageCalculator,
    EventVectorStore,
    GraphProjector,
    MemoryProjector,
...
from src.legacy.state import BackgroundJobStatus, ElderProfile, SessionState, TurnRecord
...
class SessionOrchestrator:
    ...
    async def process_user_response(self, user_response: str) -> Dict[str, Any]:
        ...
        turn_debug_trace["interviewer_llm_ms"] = _interviewer_llm_ms
        ...
        turn_debug_trace["token_usage"] = _token_usage.to_dict()
    ...
    def _build_generation_hints(
        ...
        # Legacy pipeline does not use Neo4j relation service.
    ...
    def _empty_merge_result():
        ...
        from src.legacy.services.merge_engine import MergeResult
        return MergeResult()
